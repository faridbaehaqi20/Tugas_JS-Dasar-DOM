# Nama: Muhammad Farid Baehaqi (tim: FE-8)
...
### Jawaban :
jawaban tertera pada file [Section2-4.html](https://github.com/faridbaehaqi20/Tugas_JS-Dasar-DOM/blob/main/section%202-4.html "Github Muhammad Farid Baehaqi")
...
<body>
    ...
    <script>
      ...
      // Minimal 3 contoh
      // innerHTML
      nextSibling.innerHTML = "Dibuat Oleh Muhammad Farid Baehaqi";
      // textContent
...
### Jawaban :
jawaban tertera pada file [Section4-6.html](https://github.com/faridbaehaqi20/Tugas_JS-Dasar-DOM/blob/main/section%204-6.html "Github Muhammad Farid Baehaqi")
...
``` html
 <body>
    ...
    <script>
      ...
      input.setAttribute("value", "Ini adalah value yang dibuat dengan setAtribute()");
...
### Jawaban :
jawaban tertera pada file [Section7-8.html](https://github.com/faridbaehaqi20/Tugas_JS-Dasar-DOM/blob/main/section%207-8.html "Github Muhammad Farid Baehaqi")
